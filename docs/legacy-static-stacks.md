# Legacy static stacks

This document describes the pre-product-shell named Compose workflows. They remain available for existing autonomy integration work, but they are not the ScenarioSpec product quick start.
